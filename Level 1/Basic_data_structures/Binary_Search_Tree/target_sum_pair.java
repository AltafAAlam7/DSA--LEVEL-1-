...
//     int newtar = tar-node.data;
//     if(node.data<newtar)
//     {
//         if(find(root, newtar)==true)
//             System.out.println(node.data+" "+newtar);
//     }
...
//   }
    ...
    public static Node II(Stack<IPair> st)
    {
        while(st.size()>0)
        {
            IPair top = st.peek();
    ...
    public static Node RII(Stack<IPair> st)
    {
        while(st.size()>0)
        {
            IPair top = st.peek();
